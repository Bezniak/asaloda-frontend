            ...
            <div className="flex flex-col md:flex-row items-start md:items-center">
                ...
                <div className="w-full md:w-1/2 p-4">
                    ...
                    <div className="mb-14 mt-14">
                        ...
                        <p className="text-gray-700 text-left">Делаем заготовки овощей и мяса, готовим салаты и молочные
                            блюда в
                            охлажденном до 8 градусов помещении, где поддерживается постоянная температура. Эта
                            технология позволяет сохранить максимум полезности и витаминов.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 text-left">Мы заботимся об окружающей среде. Курьер может забрать
                            нашу упаковку на переработку.</p>
                    </div>
                </div>
            </div>
        </div>
