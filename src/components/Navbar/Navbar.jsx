            ...
            <nav className="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div
                        ...
                        } mb-5 items-center justify-between font-medium w-full md:flex md:w-auto md:order-1 mobile-menu`}
                    >
                ...
                {isProgramDropdownVisible && (
                    ...
                    >
                        <div className="grid max-w-screen-xl px-4 py-1 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
                            <ul>
                                <li>
                                    <a
                                        href="#"
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="text-sm text-gray-500 dark:text-gray-400">Здоровье в каждом глотке</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
