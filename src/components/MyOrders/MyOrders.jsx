                        ...
                        <div  className="bg-white shadow-lg rounded-lg p-6 mb-10">
                            ...
                            <div className="flex justify-between items-start">
                                <div className="flex flex-col justify-start items-start">
                                    ...
                                    <p><span
                                        className="font-bold">Время доставки:</span> {order.attributes.deliveryTime}
                                    </p>
                                    <p><span
                                ...
                                <div className="flex flex-col justify-end items-end">
                                    <p><span className="font-bold">Стоимость:</span> {order.attributes.totalPrice} BYN
                                    </p>
                                    <p><span
                                        className="font-bold">Продолжительность:</span> {order.attributes.duration} дней
                                    </p>
                                    ...
                                    {order.attributes.promoCode && (
                                        <p><span
                                            className="font-bold">Промо-код:</span> {order.attributes.promoCodeValue}
                                        </p>
                                    )}
                                </div>
                            </div>
