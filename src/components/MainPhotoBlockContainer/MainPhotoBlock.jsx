...
const MainPhotoBlock = ({
    ...
    return (
        <div className='flex items-center justify-center py-16 md:py-32 p-6 md:mt-14' style={{backgroundColor: bgColor}}>
            <div className="flex flex-col gap-5 items-center md:flex-row md:max-w-5xl w-full">
                <div className="flex flex-col md:justify-center p-4 w-full md:w-1/2 text-center md:text-left">
                    <h1 className="mb-5 text-4xl md:text-5xl font-bold text-white md:text-left xs:text-center" style={{color: colorText}}>
                        {title}
                    </h1>
                    ...
                    <p className="mb-6 font-normal text-white md:text-left xs:text-center" style={{color: colorText}}>
                        {description}
                    </p>
