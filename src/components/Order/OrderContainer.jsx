...
//
// const OrderContainer = ({program, programImg, color, replacedDishes, allDish}) => {
//     return (
//         <div className='bg'>
...
//                     </div>
//                 </div>
//                 <OrderForm program={program} color={color} replacedDishes={replacedDishes} allDish={allDish}/>
//             </div>
//         </div>
//     );
// };
